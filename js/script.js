...
if (currUser) {
  ...
  if (loginForm) {
    loginForm.innerHTML = "";
    usernameOut.innerHTML =
      'Kamu Sekarang Masuk Sebagai : <br> <i class="fas fa-user"></i> ' + currUser;
  }
}
...
if (loginBtn) {
  if (!currUser) {
    ...
    loginBtn.innerHTML = "Keluar Akun";
...
function updateTotal(moneyChange) {
  ...
  if (totalAmount > 1) {
    ...
    total.innerHTML = `<br>
      ...
      Tambahkan item ke keranjang dengan mengarahkan kursor ke atas / mengetuk gambar produk
      di halaman Menu.`;
  }
}
...
function initializeItem10() {
  ...
  remove10.addEventListener("click", function () {
    item10Display.innerHTML = "";
    updateTotal(-46.2 * item10Counter);
    item10Counter = 0;
    Storage.removeAmount("item10");
  });
}
...
function initializeItem11() {
  ...
  remove11.addEventListener("click", function () {
    item11Display.innerHTML = "";
    updateTotal(-35.0 * item11Counter);
    item11Counter = 0;
    Storage.removeAmount("item11");
  });
}
...
function initializeItem12() {
  ...
  remove12.addEventListener("click", function () {
    item12Display.innerHTML = "";
    updateTotal(-44.0 * item12Counter);
    item12Counter = 0;
    Storage.removeAmount("item12");
  });
}
